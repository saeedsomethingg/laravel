...
@section('content')
     ...
     <main class="flex-1 p-8">
        <header class="bg-white shadow rounded-lg p-6 mb-8 flex items-center justify-between">
            ...
            <a href="{{route('employees.create')}}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">
                        ...
                        @foreach($employees as $employee)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap flex items-center space-x-2 space-x-reverse">
                                    <a href="{{route('employees.edit',$employee->id)}}" class="text-blue-600 hover:text-blue-800 ml-2" title="جزئیات">
